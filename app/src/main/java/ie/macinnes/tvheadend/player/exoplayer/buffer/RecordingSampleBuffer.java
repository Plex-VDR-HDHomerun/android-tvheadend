...
import ie.macinnes.tvheadend.player.exoplayer.MpegTsPlayer;
import ie.macinnes.tvheadend.tvinput.PlaybackBufferListener;
import ie.macinnes.tvheadend.player.exoplayer.SampleExtractor;
...
public class RecordingSampleBuffer implements BufferManager.SampleBuffer,
    ...
    private boolean maybeReadSample(com.android.tv.tuner.exoplayer.buffer.SampleQueue queue, int index) {
    ...
    public boolean continueBuffering(long positionUs) {
        ...
        for (int i = 0; i < mTrackCount; ++i) {
            ...
            com.android.tv.tuner.exoplayer.buffer.SampleQueue queue = mReadSampleQueues.get(i);
